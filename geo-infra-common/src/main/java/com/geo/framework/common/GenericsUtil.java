...
public class GenericsUtil{
	/**
	 * 获得指定类的父类的泛型参数的实际类型
	 * @param clazz clazz需要反射的类,该类必须继承范型父类
	...
	/**
	 * 获得指定类的父类的第一个泛型参数的实际类型
	 * @param clazz clazz 需要反射的类,该类必须继承泛型父类
	 * @return 泛型参数的实际类型, 如果没有实现ParameterizedType接口，即不支持泛型，直接返回Object.class
	 */
	 ...
	 * @return 输入参数的泛型参数的实际类型集合, 如果没有实现ParameterizedType接口，即不支持泛型，直接返回空集合
	 */
